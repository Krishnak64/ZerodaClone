        ...
        <div className="container mt-2">
            ...
            <div className="row p-5 mt-5 mb-5">
                ...
                <h4 className="">
                    ...
                    <a href='' style={{textDecoration: "none", lineHeight:"2.5"}}>Account Modifications and Segment Addition</a><br/>
                ...
                <h4 className="">
                    ...
                    <a href='' style={{textDecoration: "none", lineHeight:"2.5"}}>Margin/leverage, Product and Orderrr types</a><br/>
                ...
                <h4 className="">
                    ...
                    <a href='' style={{textDecoration: "none", lineHeight:"2.5"}}>Referal Program</a><br/>
                </div>

                <div className="col-4 p-5 mt-2 mb-2">
                <h4 className="">
                    <i class="fa fa-bar-chart" aria-hidden="true"></i>   Coin
                    </h4>
